            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Live Open Calls</h4>
                                        ...
                                        <tbody>
                                            @foreach ($calls as $key => $call)
                                                <tr>
                                                    ...
                                                    <td> <img src="{{ asset($call->call_image) }}" style="height:30px">
                                                    </td>
                                                    <td> <a href="{{ route('edit_call', $call->id) }}"><button
                                                                class="btn btn-sm
                            btn-primary">Edit</button></a>
                                                        <a href="{{ route('delete_call', $call->id) }}"><button
                                                                class="btn btn-sm btn-danger">Delete</button></a>
                                                        <button type="button" class="btn btn-sm btn-secondary"
                                                            data-bs-toggle="modal"
                                                            data-bs-target="#callModal{{ $key }}">View Call
                                                        </button>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title"
                                                                    id="callModal{{ $key }}Label">Call Details
                                                                </h5>
