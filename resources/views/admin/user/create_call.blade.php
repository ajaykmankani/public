                    ...
                    <div class="col-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{route('create_user')}}" method="post" class="form-sample">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input type="number" name="segment" class="form-control" value="{{
                                                     old
                                                    ('target') }}" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    ...
                                                    <option selected disabled>Select Subscription</option>
                                                        <option @if($subscription->subscription_name ?? null == '1m') selected @endif value="1m">1 Month</option>
                                                        <option @if($subscription->subscription_name ?? null == '2m') selected @endif value="2m">2 Months</option>
                                                        <option @if($subscription->subscription_name ?? null == '3m') selected @endif value="3m">3 Months</option>
                                                        <option @if($subscription->subscription_name ?? null == '1y') selected @endif value="1y">1 Year</option>
                                                        <option @if($subscription->subscription_name ?? null == '2y') selected @endif value="2y">2 Year</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
