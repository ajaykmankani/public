...
if ($currentSegment == 'future_package') {
    $data = array(
...
if ($currentSegment == 'equity_package') {
    $data = array(
...
if ($currentSegment == 'option_package') {
    $data = array(
...
if ($currentSegment == 'ags_trades_package') {
    $data = array(
...
if ($currentSegment == 'hni_packages') {
    $data = array(
...
if ($currentSegment == 'index_future_hni_services') {
    $data = array(
...
if ($currentSegment == 'sb_premium_packages') {
    $data = array(
...
<section class="pricing-main" id="future-package">
    <div class="container">
        ...
        <div class="row">
            <?php if ($currentSegment == 'hni-packages.php' || $currentSegment == 'index-future-hni-services.php' || $currentSegment == 'sb-premium-packages.php') { ?>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-12">
                <div class="single-pricing">
                    ...
                    <button type="button" class="thm-btn" data-toggle="modal" data-target="#exampleModalCenter">
                        Buy Now
                    </button>
                </div>
            </div>
            ...
            <div class="modal-body">
                <div class="payment-box">
                    <div class="text-center">
                        <img class="" src="assets/images/barcode.jpg" alt="" width="100%">
                    </div>
                    <h4>UPI</h4>
